...
(function($, window, document, undefined) {
  ...
  Timepicker.prototype = {
    ...
    getTemplate: function() {
      ...
      if (this.showInputs) {
        hourTemplate = '<input type="text" readonly class="bootstrap-timepicker-hour" maxlength="2"/>';
        minuteTemplate = '<input type="text" readonly class="bootstrap-timepicker-minute" maxlength="2"/>';
        secondTemplate = '<input type="text" readonly class="bootstrap-timepicker-second" maxlength="2"/>';
        meridianTemplate = '<input type="text" readonly class="bootstrap-timepicker-meridian" maxlength="2"/>';
      } else {
